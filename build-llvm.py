...
common_cmake_defines["CMAKE_C_FLAGS"] = "--target=aarch64-linux-musl --sysroot=/workspace/build-clang/android-ndk-r28/toolchains/llvm/prebuilt/linux-x86_64"
common_cmake_defines["CMAKE_CXX_FLAGS"] = "--target=aarch64-linux-musl --sysroot=/workspace/build-clang/android-ndk-r28/toolchains/llvm/prebuilt/linux-x86_64"
